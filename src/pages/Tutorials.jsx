  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="text-xs text-slate-700 text-center pb-4">
        To add a tutorial: create a <code className="font-mono">.md</code> file in <code className="font-mono">public/data/tutorials/</code> and add an entry to <code className="font-mono">index.json</code>.
      </div>
    </div>
  );
}
